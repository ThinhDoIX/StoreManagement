...
namespace StoreManager {
    ...
    public partial class StoreDBDataSet4 : global::System.Data.DataSet {
        ...
        public partial class NhaCungCapDataTable : global::System.Data.TypedTableBase<NhaCungCapRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public NhaCungCapRow AddNhaCungCapRow(string maNCC, string tenNCC, string sodienthoai, string diachi) {
...
namespace StoreManager.StoreDBDataSet4TableAdapters {
    ...
    public partial class NhaCungCapTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NhaCungCap] ([maNCC], [tenNCC], [sodienthoai], [diachi]) VALUE" +
                "S (@maNCC, @tenNCC, @sodienthoai, @diachi);\r\nSELECT maNCC, tenNCC, sodienthoai, " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhaCungCap] SET [maNCC] = @maNCC, [tenNCC] = @tenNCC, [sodienthoai] = @sodienthoai, [diachi] = @diachi WHERE (([maNCC] = @Original_maNCC) AND ((@IsNull_tenNCC = 1 AND [tenNCC] IS NULL) OR ([tenNCC] = @Original_tenNCC)) AND ((@IsNull_sodienthoai = 1 AND [sodienthoai] IS NULL) OR ([sodienthoai] = @Original_sodienthoai)) AND ((@IsNull_diachi = 1 AND [diachi] IS NULL) OR ([diachi] = @Original_diachi)));
SELECT maNCC, tenNCC, sodienthoai, diachi FROM NhaCungCap WHERE (maNCC = @maNCC)";
        ...
        public virtual int Fill(StoreDBDataSet4.NhaCungCapDataTable dataTable) {
        ...
        public virtual StoreDBDataSet4.NhaCungCapDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StoreDBDataSet4.NhaCungCapDataTable dataTable = new StoreDBDataSet4.NhaCungCapDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StoreDBDataSet4.NhaCungCapDataTable dataTable) {
        ...
        public virtual int Delete(string Original_maNCC, string Original_tenNCC, string Original_sodienthoai, string Original_diachi) {
        ...
        public virtual int Insert(string maNCC, string tenNCC, string sodienthoai, string diachi) {
            if ((maNCC == null)) {
        ...
        public virtual int Update(string maNCC, string tenNCC, string sodienthoai, string diachi, string Original_maNCC, string Original_tenNCC, string Original_sodienthoai, string Original_diachi) {
            if ((maNCC == null)) {
                throw new global::System.ArgumentNullException("maNCC");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string tenNCC, string sodienthoai, string diachi, string Original_maNCC, string Original_tenNCC, string Original_sodienthoai, string Original_diachi) {
            return this.Update(Original_maNCC, tenNCC, sodienthoai, diachi, Original_maNCC, Original_tenNCC, Original_sodienthoai, Original_diachi);
        }
    }
